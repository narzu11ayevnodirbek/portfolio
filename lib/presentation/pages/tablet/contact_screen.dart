...
class ContactScreenTablet extends StatefulWidget {
  const ContactScreenTablet({super.key});

  @override
  State<ContactScreenTablet> createState() => _ContactScreenMobileState();
}

class _ContactScreenMobileState extends State<ContactScreenTablet> {
